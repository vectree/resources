...
Что если нам необходимо объединить несколько ячеек? Для этих целей в **HTML** присутствуют атрибут `colspan`, который задает число ячеек, объединённых по горизонтали и атрибут `rowspan`, задающий количество ячеек для объединения по горизонтали.
