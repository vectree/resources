...
Для достижения нашей цели мы собираем лучшие материалы и ресурсы со всего интернета и агрегируем их в единую траекторию (roadmap). При необходимости переводим или дополняем практическими заданиями, тестами. 
