...
HTML - язык разметки, с помощью которого создается каркас страницы. 
...
Рассмотрим каким образом исполуются элементы HTML.

![alt text](https://user-images.githubusercontent.com/4215285/48320852-00702100-e62f-11e8-8417-72d68b954a06.png)

Итак, обычно элемент состоит из открывающего тега, контента и закрывающего тега (см. рисунок выше).
